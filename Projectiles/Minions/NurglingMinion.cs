using WarhammerLegendaryItems.Items;
...
namespace WarhammerLegendaryItems.Projectiles.Minions
{
	...
	public class NurglingMinion : ModProjectile
	{
		...
		private bool CheckActive(Player owner) {
			if (owner.dead || !owner.active) {
				owner.ClearBuff(ModContent.BuffType<NurglingMinionBuff>());

				return false;
			}

			if (owner.HasBuff(ModContent.BuffType<NurglingMinionBuff>())) {
